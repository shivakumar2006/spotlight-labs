...
const AuthButtonWithProvider = ({ Icon, Label, Provider}) => {
  ...
  return (
    <div onClick={handleLogin} className='w-120 h-10 px-4 py-3 flex items-center justify-center border-gray-400 hover:border-gray-600 rounded-md border-1 cursor-pointer group hover:bg-gray-100 active:scale-95 duration-150 hover:shadow-md gap-2'>
